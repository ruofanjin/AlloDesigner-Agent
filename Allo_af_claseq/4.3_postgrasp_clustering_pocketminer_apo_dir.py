...
csv_file = './AF_ClaSeq/case/PCKS9/4ne9/run/01_iterative_shuffling/Iteration_1/step3_select_pocket_cluster_residues/pocketminer_cluster_deepallo_score_eps4.5/final_select_cluster_residues.csv'
...
binding_residues = df['residues'].tolist()
...
for i in range(10, 11):
    ...
    output_folder = os.path.join(base_dir, f"shuffle_{i}_pocketminer_predict_residues_cluster/eps{eps}_min_samples2")
