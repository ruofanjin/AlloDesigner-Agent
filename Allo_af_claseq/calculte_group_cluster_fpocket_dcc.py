...
def get_structure_center(pdb_path):
    ...
    if coords:
        return calculate_center(np.array(coords))
    else:
        return None
...
pdb_folder = "./AF_ClaSeq/case/GPL1/6x18_chianR_R/run/01_iterative_shuffling/Iteration_1/shuffle_5_pocketminer_holo_cluster/eps6_min_samples2"  
group_root_folder = "./AF_ClaSeq/case/GPL1/6x18_chianR_R/run/01_iterative_shuffling/Iteration_1/shuffle_5_fpocket"  
output_csv = "./AF_ClaSeq/case/GPL1/6x18_chianR_R/run/01_iterative_shuffling/Iteration_1/shuffle_5_group_cluster_fpocket_distance_results.csv"
