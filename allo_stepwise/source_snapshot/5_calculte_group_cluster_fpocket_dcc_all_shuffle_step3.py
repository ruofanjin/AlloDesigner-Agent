...
base_path = "./AF_ClaSeq/case/PCKS9/4ne9/run/01_iterative_shuffling/Iteration_8"

for i in range(1, 11):

    pdb_folder = os.path.join(base_path, f"shuffle_{i}_pocketminer_predict_residues_cluster/eps6_min_samples2")
    ...
    output_csv = os.path.join('./AF_ClaSeq/case/PCKS9/4ne9/run/01_iterative_shuffling/Iteration_8/pocketminer_predict_residues_cluster_eps6', f"shuffle_{i}_group_cluster_fpocket_distance_results.csv")
