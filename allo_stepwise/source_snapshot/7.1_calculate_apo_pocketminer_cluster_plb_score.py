...
def process_shuffle_files(base_dir, top_k=3):
    ...
    for i in range(1, 11):
        csv_file = os.path.join(base_dir, f"pocketminer_cluster_deepallo_plb_shuffle_{i}.csv")
        ...
        for group_id, group_df in grouped:
            top_clusters = group_df.sort_values('plb_score', ascending=False).head(top_k)
...
if __name__ == "__main__":
    #base_directory = "./AF_ClaSeq/case/GPL1/6x18_chianR_R/run/01_iterative_shuffling/Iteration_1/pocketminer_cluster_deepallo_score/plb_score"  
    base_directory = './AF_ClaSeq/case/PCKS9/4ne9/run/01_iterative_shuffling/Iteration_1/pocketminer_cluster_deepallo_score_eps4.5/plb_score'
    top_k = 7  
