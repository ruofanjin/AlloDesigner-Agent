...
base_path = "./AF_ClaSeq/case/PCKS9/4ne9/run/02_m_fold_sampling/round_1/02_sampling"

for i in range(28, 38):

    pdb_folder = os.path.join(base_path, f"sampling_{i}_pocketminer_predict_residues_cluster/eps6_min_samples2")
    group_root_folder = os.path.join(base_path, f"sampling_{i}_fpocket")
    # output_csv = os.path.join('./AF_ClaSeq/case/GPL1/6x18_chianR_R/run/01_iterative_shuffling/Iteration_1/pocketminer_predict_residues_cluster', f"shuffle_{i}_group_cluster_fpocket_distance_results.csv")
    output_csv = os.path.join('./AF_ClaSeq/case/PCKS9/4ne9/run/02_m_fold_sampling/round_1/02_sampling/pocketminer_predict_residues_cluster_eps6', f"sampling_{i}_group_cluster_fpocket_distance_results.csv")
