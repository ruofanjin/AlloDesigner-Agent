...
class MQAModel(Model):
    def __init__(self, node_features, edge_features,
        ...
        regression=False, multiclass=False,multilabel=False,
        ablate_aa_type=False, ablate_sidechain_vectors=True,
        ablate_rbf=False, use_lm=False,class_weights=None,
        squeeze_lm=False):
            
        super(MQAModel, self).__init__()
        
        # self.class_weights = class_weights if class_weights is not None else [1.0, 1.0, 1.0]
    ...
    def call(self, X, S, mask, train=False, res_level=False, ablate_aa_type=False):
        ...
        h_V_out = self.W_V_out(h_V, return_split=False)
